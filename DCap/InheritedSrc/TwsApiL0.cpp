...
#include "../../source/PosixClient/src/EPosixClientSocket.cpp"
#include "../../source/PosixClient/src/EClientSocketBase.cpp"	//	CLIENT_VERSION
#undef private
...
//		return EPosixClientSocket::receive( buf, sz );
	...
	//	fprintf( stderr, "ThreadId = %d    \r", CurrentThreadId() );
		...
		struct timeval timeout = {0,(int)waitfor};	// wait for some milli/micro seconds
